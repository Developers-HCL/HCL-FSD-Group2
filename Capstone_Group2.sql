...
--  delete from product where name ="NAAN";
-- -----------------------------------------------------
...
INSERT INTO product(sku, name, description, image_url, active, units_in_stock,
unit_price, category_id,date_created)
VALUES ('PunjabiRasoi-1001', 'IndianThalli', 'contains 85 calories per 100 gram',
...
INSERT INTO product(sku, name, description, image_url, active, units_in_stock,
unit_price, category_id,date_created)
VALUES ('RotiGhar-1001', 'KULFI', 'contains 500 calories per 100 gram',
'assets/images/products/rotiGhar/kulfi.png'
,1,100,70,3, NOW());

INSERT INTO product(sku, name, description, image_url, active, units_in_stock,
unit_price, category_id,date_created)
VALUES ('RotiGhar-1002', 'DOSA', 'contains 10 calories per 100 gram',
...
INSERT INTO product(sku, name, description, image_url, active, units_in_stock,
unit_price, category_id,date_created)
VALUES ('Udupi-1001', 'IDLY', 'contains 30 calories per 150 gram',
'assets/images/products/udupi/idly.png'
,1,100,98,4, NOW());

INSERT INTO product(sku, name, description, image_url, active, units_in_stock,
unit_price, category_id,date_created)
VALUES ('Udupi-1002', 'SAMOSA', 'contains 60 calories per 40 gram',
'assets/images/products/udupi/samosa.png'
,1,100,55,4, NOW());

INSERT INTO product(sku, name, description, image_url, active, units_in_stock,
unit_price, category_id,date_created)
VALUES ('Udupi-1003', 'MIXEDDESERT', 'contains 60 calories per 40 gram',
'assets/images/products/udupi/mixeddesert.png'
,1,100,55,4, NOW());

INSERT INTO product(sku, name, description, image_url, active, units_in_stock,
unit_price, category_id,date_created)
VALUES ('Udupi-1004', 'GulabJamun', 'contains 97 calories per 100 gram',
